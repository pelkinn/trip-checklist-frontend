...
export default defineNuxtConfig({
  ...
  app: {
    head: {
      ...
      meta: [
        ...
        {
          name: 'description',
          content: 'Trip Checklist — создавайте персональные чеклисты для ваших путешествий. Организуйте поездки с помощью удобных списков.'
        },
  ...
  vite: {
    ...
    css: {
      preprocessorOptions: {
        scss: {
          additionalData: [`@use 'sass:map';`, `@use '~/assets/style/vuetify' as v;`].join(' ')
        }
      }
    },
