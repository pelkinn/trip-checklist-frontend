        ...
        <div v-if="isLoading && !hasChecklists" class="text-center py-8">
         ...
         <div v-else-if="!hasChecklists" class="empty-state">
           ...
           <p class="empty-description">
             Создайте свой первый чеклист для путешествия, выбрав тип поездки и длительность
           </p>
          <UiBaseButton variant="primary" size="large" @click="showCreateForm = true">
          ...
          <form @submit.prevent="createChecklist">
            ...
            <div class="form-actions">
              ...
              <UiBaseButton 
                type="submit" 
                variant="primary"
                :disabled="isLoading || !newChecklist.tripTypeId || !newChecklist.durationId"
              >
...
useHead({
  ...
  meta: [
    { name: 'description', content: 'Управляйте своими персональными чеклистами путешествий' }
  ]
})
</script>
